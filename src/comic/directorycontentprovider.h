...
#ifndef DIRECTORY_CONTENT_PROVIDER_H
#define DIRECTORY_CONTENT_PROVIDER_H

class DirectoryContentProvider : public ContentProvider
{
public:
    DirectoryContentProvider(const std::string& path);
...
#endif // DIRECTORY_CONTENT_PROVIDER_H
